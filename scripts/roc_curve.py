...
pos_hits = parse_tbl("hits_pos.tbl")
neg_hits = parse_tbl("hits_neg.tbl")
n = len(pos_ids)
 
# Build scores: use -log10(evalue) as score, cap at 100
...
all_scores = np.linspace(min(all_scores)-0.1, max(all_scores)+0.1, 500)
